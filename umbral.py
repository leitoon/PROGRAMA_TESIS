...
def histogramaGray(img):
    ...
    plt.show()
imgColor=cv2.imread('D:\\PROGRAMA_TESIS\\imagenes_procesamiento\\imagen22.jpg',cv2.COLOR_BGR2RGB)
imgGray=cv2.imread('D:\\PROGRAMA_TESIS\\imagenes_procesamiento\\imagen22.jpg',0)
